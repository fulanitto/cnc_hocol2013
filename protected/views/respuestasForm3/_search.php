...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="control-group">
		<?php echo $form->label($model,'p09'); ?>
		<?php echo $form->textField($model,'p09',array('size'=>45,'maxlength'=>45)); ?>
	</div>
	...
	<div class="control-group">
		<?php echo $form->label($model,'Pc01_i'); ?>
		<?php echo $form->textField($model,'Pc01_i',array('size'=>45,'maxlength'=>45)); ?>
	</div>
