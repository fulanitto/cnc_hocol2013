        ...
        <div class="control-group">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="width: 50%; background-color: #eeeeee; "><?php echo $form->labelEx($model, 'p04'); ?></td>
                        <?php echo $form->radioButtonList($model, 'p04', Obrero::getEscala1a10(), array('template' => '<td style="text-align: center; vertical-align: middle;"> {input} </td>', 'class' => 'inline', )); ?>
                    </tr>
                    <tr>
                        <td style="width: 50%; background-color: #eeeeee; "><?php echo $form->labelEx($model, 'p05'); ?></td>
                        <?php echo $form->radioButtonList($model, 'p05', Obrero::getEscala1a10(), array('template' => '<td style="text-align: center; vertical-align: middle;"> {input} </td>', 'class' => 'inline', )); ?>
                    </tr>
                    <tr>
                        <td style="width: 50%; background-color: #eeeeee; "><?php echo $form->labelEx($model, 'p06'); ?></td>
                        <?php echo $form->radioButtonList($model, 'p06', Obrero::getEscala1a10(), array('template' => '<td style="text-align: center; vertical-align: middle;"> {input} </td>', 'class' => 'inline', )); ?>
                    </tr>
                    <tr>
                        <td style="width: 50%; background-color: #eeeeee; "><?php echo $form->labelEx($model, 'p07'); ?></td>
                        <?php echo $form->radioButtonList($model, 'p07', Obrero::getEscala1a10(), array('template' => '<td style="text-align: center; vertical-align: middle;"> {input} </td>', 'class' => 'inline', )); ?>
                    </tr>
                </tbody>
            </table>
        </div>
