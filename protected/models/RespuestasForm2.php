...
/**
 * This is the model class for table "respuestas_form2".
 *
 * The followings are the available columns in table 'respuestas_form2':
 ...
 */
class RespuestasForm2 extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RespuestasForm2 the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			//nuevos
			array('id_con', 'unique'),
			array('pA01, pA02, pA03, PA04, pB01, pB02, pB03, pB04, pB05, pB06, p01, p02, p03, p04, p05, p06, p07, p08, pC01, pD01, pD02, pD03', 'default', 'value'=>'99', 'setOnEmpty'=>true),
			//fin nuevos
			...
			array('pA01, pA02, PA04, pB01, pB02, pB03, pB04, pB05, pB06, p01, p02, p03, p04, p05, p06, p07, p08, pC01', 'length', 'max'=>45),
			array('pA03, pD01, pD02, pD03', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_con, nom_contacto, id_servicio, servicio, fecha_encuesta, pA01, pA02, pA03, PA04, pB01, pB02, pB03, pB04, pB05, pB06, p01, p02, p03, p04, p05, p06, p07, p08, pC01, pD01, pD02, pD03', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'pA01' => 'En general su relación con las personas de la <b>Gerencia Administrativa</b> se hace a través de qué canal:',
			'pA02' => '¿Cómo califica el manejo dado a la relación por este canal?',
			'pA03' => '¿Hay algo que haga falta en relación a lo que hace la <b>Gerencia Administrativa</b>?¿Qué no encuentra? ¿Qué mejoras debe hacer en sus procesos? Qué le hace falta tener en cuenta?',
			'PA04' => '¿Cómo califica usted su nivel de conocimiento sobre lo que hace la <b>Gerencia Administrativa</b>?',
			'pB01' => 'Calidad general de la <b>Gerencia Administrativa</b>',
			...
			'p01' => 'Transporte y Comercialización de Hidrocarburos',
			'p02' => 'Administración de Materiales',
			'p03' => 'Abastecimiento de bienes y servicios',
			'p04' => 'Gestión Integral de Riesgos',
			'p05' => 'Procesos IT',
			'p06' => 'No va',
			'p07' => 'No va',
			'p08' => 'No va ',
			'pC01' => 'Usted diría que la <b>Gerencia Administrativa</b>...',
			'pD01' => 'Para usted, ¿cuál es la característica más importante que debe tener en cuenta la <b>Gerencia Administrativa</b>?',
			'pD02' => '¿Qué se está haciendo bien en la <b>Gerencia Administrativa</b>?',
			'pD03' => '¿Qué se debe mejorar o qué hace falta hacer en la <b>Gerencia Administrativa</b>?',
		);
	}
