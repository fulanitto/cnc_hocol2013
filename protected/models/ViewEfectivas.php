...
/**
 * This is the model class for table "view_efectivas".
 *
 * The followings are the available columns in table 'view_efectivas':
 ...
 */
class ViewEfectivas extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ViewEfectivas the static model class
	 */
