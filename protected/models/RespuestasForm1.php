...
/**
 * This is the model class for table "respuestas_form1".
 *
 * The followings are the available columns in table 'respuestas_form1':
 ...
 */
class RespuestasForm1 extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RespuestasForm1 the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			//nuevos
			array('id_con', 'unique'),
			array('pA01, pA02, pA03, PA04, pB01, pB02, pB03, pB04, pB05, pB06, p01, p02, p03, p04, p05, p06, p07, pC01, pD01, pD02, pD03', 'default', 'value'=>'99', 'setOnEmpty'=>true),
			//fin nuevos
			...
			array('pA01, pA02, PA04, pB01, pB02, pB03, pB04, pB05, pB06, p01, p02, p03, p04, p05, p06, p07, pC01', 'length', 'max'=>45),
			array('pA03, pD01, pD02, pD03', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_con, nom_contacto, id_servicio, servicio, fecha_encuesta, pA01, pA02, pA03, PA04, pB01, pB02, pB03, pB04, pB05, pB06, p01, p02, p03, p04, p05, p06, p07, pC01, pD01, pD02, pD03', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'pA01' => 'En general su relación con las personas de la <b>Gerencia de Estrategia y Crecimiento</b> se hace a través de qué canal:',
			'pA02' => '¿Cómo califica el manejo dado a la relación por este canal?',
			'pA03' => '¿Hay algo que haga falta en relación a lo que hace la <b>Gerencia de Estrategia y Crecimiento</b>?¿Qué no encuentra? ¿Qué mejoras debe hacer en sus procesos? Qué le hace falta tener en cuenta?',
			'PA04' => '¿Cómo califica usted su nivel de conocimiento sobre lo que hace la <b>Gerencia de Estrategia y Crecimiento</b>?',
			'pB01' => 'Calidad general de la <b>Gerencia de Estrategia y Crecimiento</b>',
			...
			'p01' => 'Comunicaciones Externas ',
			'p02' => 'Comunicaciones Internas',
			'p03' => 'Responsabilidad social ',
			'p04' => 'Definición y Revisión de la Estrategia',
			'p05' => 'Implementación y Seguimiento a la estrategia',
			'p06' => 'Evaluaciones Económicas y Paneles Técnicos',
			'p07' => 'Gestión de Proyectos ',
			'pC01' => 'Usted diría que la <b>Gerencia de Estrategia y Crecimiento</b>...',
			'pD01' => 'Para usted, ¿cuál es la característica más importante que debe tener en cuenta la <b>Gerencia de Estrategia y Crecimiento</b>?',
			'pD02' => '¿Qué se está haciendo bien en la <b>Gerencia de Estrategia y Crecimiento</b>?',
			'pD03' => '¿Qué se debe mejorar o qué hace falta hacer en la <b>Gerencia de Estrategia y Crecimiento</b>?',
		);
	}
